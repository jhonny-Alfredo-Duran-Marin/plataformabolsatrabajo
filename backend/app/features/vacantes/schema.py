...
class JobSkillItemRequest(BaseModel):
    ...
    skill_id: uuid.UUID
    required_level: SkillProficiencyLevel | None = None
...
class VacanteCreateRequest(BaseModel):
    ...
    responsibilities: str | None = Field(default=None, description="Responsabilidades principales")
    requirements: str | None = Field(default=None, description="Requisitos y perfil buscado")
    ...
    required_experience_years: Decimal | None = Field(default=Decimal("0.0"), ge=0)
...
class VacanteUpdateRequest(BaseModel):
    ...
    minimum_education_level: str | None = None
    required_experience_years: Decimal | None = Field(default=None, ge=0)
...
class VacanteResponse(BaseModel):
    ...
    minimum_education_level: str | None = None
    required_experience_years: Decimal | None = None
